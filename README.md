...
- **Clear Lens design mode** — Settings can switch between the current design and the new Focus Ring / Clear Lens design; the choice persists across restarts while the app name remains FundLens
