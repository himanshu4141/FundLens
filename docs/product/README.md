...
This directory contains product requirements, design assets, and project plans for FundLens features.

## Tools Hub

| File | Description |
|---|---|
| [fundlens-tools-hub-prd.md](fundlens-tools-hub-prd.md) | Product Requirements Document for Tools Hub (M0–M6) |
