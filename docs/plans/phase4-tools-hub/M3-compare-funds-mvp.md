...
- [ ] Branch `feat/tools-hub-m3` created off `feat/tools-hub-m2`
- [ ] M3 ExecPlan written
- [ ] Confirm fund meta and composition data availability (TECH-DISCOVERY.md)
- [ ] `compareFunds.ts` overlap helper + trailing return helper + tests
- [ ] `ClearLensCompareFundsScreen` implemented (picker + sections)
- [ ] `app/tools/compare-funds.tsx` route created
- [ ] `toolsFlags.compareFunds` set to `true`
- [ ] typecheck + lint + tests green
- [ ] PR raised against `feat/tools-hub-m2`
