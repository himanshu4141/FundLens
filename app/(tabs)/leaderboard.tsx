  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.body}>
        ...
        <Text style={styles.title}>Performance Leaderboard</Text>
        <Text style={styles.subtitle}>
          See which of your funds are leading the market and which are lagging — ranked by
          performance vs their benchmark.
        </Text>
        <View style={styles.comingSoonBadge}>
          <Text style={styles.comingSoonText}>Coming in M3</Text>
        </View>
      </View>
    </SafeAreaView>
  );
